...
const Stats = () => {
  const stats = [
    { id: 1, name: 'Active Farmers', value: '1,200+' },
    { id: 2, name: 'Verified Buyers', value: '320+' },
    { id: 3, name: 'Markets Connected', value: '45+' },
    { id: 4, name: 'Revenue Increased', value: '28%' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="mt-3 text-xl text-green-100 sm:mt-4">
            Join hundreds of farmers who have increased their profits with FarmConnect Kenya
          </p>
        </div>
